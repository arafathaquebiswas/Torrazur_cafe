...
import { Croissant, Clock, MessageCircle, Sparkles, Eye } from 'lucide-react';
import { ImageDetailModal } from './ImageDetailModal';

interface BakeryPageProps {
  bakeryItems: MenuItem[];
  settings: SiteSettings;
}

export const BakeryPage: React.FC<BakeryPageProps> = ({ bakeryItems, settings }) => {
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div
          onClick={() => setSelectedItem({
            id: 'bakery-banner',
            name: 'Italian Bakery Showcase',
            category: 'Bakery',
            description: 'Golden, flaky butter croissants baked fresh every morning in-house.',
            price: 'Fresh Daily',
        ...
        >
          <img
            src="/images/torrazur-02.jpg"
            alt="Torrazur Freshly Baked Golden Artisanal Butter Croissants"
          ...
          <div className="relative z-10 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#C88A4B]/20 border border-[#C88A4B]/40 rounded-full text-[#E8C096] text-xs font-medium tracking-widest uppercase backdrop-blur-sm">
              <Croissant className="w-4 h-4 text-[#C88A4B]" />
            ...
            <h1 className="font-serif text-4xl sm:text-6xl font-bold tracking-tight text-[#FAF6F0] drop-shadow-md">
              ITALIAN BAKERY SHOWCASE
            </h1>
            <p className="text-sm text-[#E5D2C0] max-w-2xl mx-auto leading-relaxed drop-shadow">
              Handcrafted in Bashundhara R/A with fine flour, authentic butter, and traditional Italian baking techniques.
            </p>
          </div>
        </div>

        {/* Bakery Categories & Showcase */}
        <div className="space-y-12">
          <div className="border-b border-[#312015] pb-4 flex justify-between items-end">
            <div>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href={`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}?text=Hi%20Torrazur,%20I%20would%20like%20to%20inquire%20about%20your%20fresh%20bakery%20item:%20${encodeURIComponent(item.name)}`}
                      target="_blank"
